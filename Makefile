...
run: ## Run ansible playbook for the supplied Jira Ticket e.g make run t=TEL-2906
ifdef t
	ansible-playbook ./playbooks/$(t)/playbook.yml --inventory ./inventories/aws_ec2.yml
else
	@echo 'Ticket is not provided! usage: make $@ t=TEL-2906'
endif
